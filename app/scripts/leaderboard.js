export function initLeaderboard() {
    ...
    if(!leaderboardBtn||!leaderboardModal||!leaderboardTableBody||!closeBtn) return {saveScore:()=>{},renderLeaderboard:()=>{}};
    ...
    function saveScore(playerId,score){
        ...
        if(existing){existing.totalScore+=score;} else {scores.push({playerId,totalScore:score});}
